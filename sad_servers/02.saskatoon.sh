# Scenario: "Saskatoon": counting IPs. --> https://sadservers.com/scenarios
...
echo $(cut -d' ' -f1 /home/admin/access.log | sort | uniq -c |sort -nr | head -n 1 | awk '{print $2}') > /home/admin/highestip.txt 
